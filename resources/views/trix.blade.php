...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="https://www.unpkg.com/trix@2.1.12/dist/trix.css" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <body>
        ...
        <script src="https://www.unpkg.com/trix@2.1.12/dist/trix.umd.min.js" crossorigin="anonymous" referrerpolicy="no-referrer" defer></script>
        <script type="module">
            (function() {
